...
for fname in HTML_FILES:
    ...
    # Replace any variation of <div class="footer-social"...> ... </div>
    content = re.sub(r'<div class="footer-social"[^>]*>.*?</div>', new_social, content, flags=re.DOTALL)
    
    with open(fpath, 'w') as f:
        f.write(content)

print("Footers fully updated via Regex")
